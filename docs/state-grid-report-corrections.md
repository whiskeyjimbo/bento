...
| 1.11 | S3 reconcile | exec-strict, architecture fallback | D | `r.StateOf(execStrict) < Unavailable` (`applied.go:471`) | HANDLED. Pinned by `TestTheArchitectureFallbackDoesNotSoftenAnUnavailableExecStrict` (`applied_test.go:1402`). |
