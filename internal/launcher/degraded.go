...
func RunDegraded(cfg DegradedConfig) (int, error) {
	...
	// cover this, but only at ABI 5 (kernel 6.10+), which this tier cannot count on: it
	// is entered whenever bwrap or unprivileged userns is missing, at any kernel age.
