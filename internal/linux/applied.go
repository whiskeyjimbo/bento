...
// to the same provenance test resolveBwrap applies, and preflightLimits hands the path it
// vouched for to the launch, so the checked binary is the one exec'd on both.)
