...
// the refusal inside their own RunE, and version reports rather than raises it, where a
// check that returns nil on the only host the tests run on is otherwise unobservable - deleting the call from one of them would break
